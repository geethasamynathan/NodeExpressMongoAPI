...
studentExpressRoute.route("/create-student")
...
// Get single user
studentExpressRoute.route("/get-student/:id")
.get(async (req, res, next) => {
...
// Update user
studentExpressRoute.route("/update-student/:id")
...
// Delete student
studentExpressRoute.route("/remove-student/:id")
